...
NEXT_PUBLIC_FIREBASE_APP_ID=1:505448793868:web:xxxxxxxxxxxxxxxxxxxxxx
...
FIREBASE_CLIENT_EMAIL=firebase-adminsdk-xxxxx@celora-7b552.iam.gserviceaccount.com
# Escape newlines as \n when placing in .env.local
FIREBASE_PRIVATE_KEY="-----BEGIN PRIVATE KEY-----\\nREPLACE_WITH_KEY\\n-----END PRIVATE KEY-----\\n"
FIREBASE_DATABASE_URL=https://celora-7b552.firebaseio.com
...
NEXT_PUBLIC_SOLANA_RPC_URL=https://devnet.helius-rpc.com/?api-key=${NEXT_PUBLIC_HELIUS_API_KEY}
...
FIREBASE_EMULATORS_ENABLED=false
...
3. Sign in via Azure AD B2C flow (or Firebase if enabled)
4. Check console for `[Firebase] Client config loaded`
