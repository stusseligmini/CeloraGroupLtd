...
const envVars = [
  ...
  'NEXT_PUBLIC_APP_URL',
  'NEXT_PUBLIC_AZURE_B2C_TENANT',
  'NEXT_PUBLIC_AZURE_B2C_AUTHORITY_DOMAIN',
  'NEXT_PUBLIC_AZURE_B2C_SIGNIN_POLICY',
  'NEXT_PUBLIC_AZURE_B2C_PASSWORD_RESET_POLICY',
  'NEXT_PUBLIC_AZURE_B2C_CLIENT_ID',
  'NEXT_PUBLIC_AZURE_B2C_API_SCOPE',
  'NEXT_PUBLIC_AZURE_B2C_REDIRECT_URI',
  'NEXT_PUBLIC_AZURE_B2C_LOGOUT_URI',
];
