...
describe('Extension Integration Tests', () => {
  describe('Wallet Creation', () => {
    it('should generate a valid 12-word mnemonic', async () => {
      ...
      const { generateMnemonic } = require('../../extension/wallet/mnemonic');
    ...
    it('should encrypt and decrypt mnemonic correctly', async () => {
      const { encryptMnemonic, decryptMnemonic } = require('../../extension/wallet/crypto');
    ...
    it('should fail decryption with wrong password', async () => {
      ...
      await expect(
        decryptMnemonic(encrypted, wrongPassword, salt, iv)
      ).rejects.toThrow();
    });
  });
  ...
  describe('Jupiter Swap Integration', () => {
    it('should fetch quote from Jupiter API', async () => {
      const JupiterSwap = require('../../extension/swap-jupiter');
  ...
  describe('Transaction Signing', () => {
    it('should sign Solana transaction with keypair', async () => {
      ...
      tx.recentBlockhash = 'Test1111111111111111111111111111111111111111';
