      ...
      replyMarkup: {
        inline_keyboard: [
          [
            {
              text: '✨ Open Wallet',
              url: `${process.env.TELEGRAM_MINI_APP_URL || 'https://app.celora.com'}/wallet?telegram_id=${message.from.id}`,
            },
          ],
        ],
      },
            ...
            replyMarkup: {
              inline_keyboard: [
                [
                  {
                    text: '✨ Link Account',
                    url: `${process.env.TELEGRAM_MINI_APP_URL || 'https://app.celora.com'}/link-telegram?telegram_id=${message.from.id}`,
                  },
                ],
              ],
            },
