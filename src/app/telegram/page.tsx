...
export default function TelegramDashboard() {
  ...
  const { summary, loading, error } = useWalletSummary();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white p-4 space-y-6">
      ...
      <div className="text-center pt-4">
        <div className="text-5xl font-black bg-gradient-to-r from-cyan-400 via-cyan-300 to-blue-400 bg-clip-text text-transparent mb-2"
          style={{
