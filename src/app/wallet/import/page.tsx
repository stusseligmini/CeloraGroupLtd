...
type ImportStep = 'enter' | 'password' | 'complete';
            ...
            <>
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">Your wallet has been restored and encrypted locally.</p>
                  <div className="bg-muted p-3 rounded-md text-sm break-all">{walletAddress}</div>
                </div>
