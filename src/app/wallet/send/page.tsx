...
export default function SendPage() {
  ...
  const handleNext = () => {
    ...
    if (step === 2 && !validateAddress(toAddress, selectedWalletData?.blockchain || '')) {
      return;
    }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (addressError) {
                      validateAddress(e.target.value, selectedWalletData?.blockchain || '');
                    }
                  }}
                  onBlur={() => validateAddress(toAddress, selectedWalletData?.blockchain || '')}
