          ...
          <CardContent>
            {selectedProvider === 'moonpay' ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-600 mb-4">Ramp Network widget integration coming soon</p>
                <p className="text-sm text-gray-500 mb-4">
                  For now, please use MoonPay or visit{' '}
                  <a
                    href={`https://${rampEnvironment === 'sandbox' ? 'app.sandbox' : 'app'}.ramp.network?userAddress=${wallet.address}`}
                    target="_blank"
